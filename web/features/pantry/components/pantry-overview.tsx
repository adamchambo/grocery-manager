  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <Card className="gap-1 py-4"><CardHeader className="px-4"><CardTitle className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Tracked products</CardTitle></CardHeader><CardContent className="px-4 text-2xl font-semibold">{items.length}</CardContent></Card>
        <Card className="gap-1 py-4"><CardHeader className="px-4"><CardTitle className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Storage locations</CardTitle></CardHeader><CardContent className="px-4 text-2xl font-semibold">{locations.length}</CardContent></Card>
      </div>
      <div className="grid gap-3 rounded-xl bg-surface-muted p-3 shadow-xs md:grid-cols-[minmax(14rem,1fr)_12rem_12rem_12rem]">
      ...
      {filteredItems.length === 0 ? (
        <Card className="gap-3 py-10 text-center">
